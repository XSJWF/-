...
@WebServlet(name = "commodity_add_post_servlet", value = "/commodity_add_post_servlet")
public class commodity_add_post_servlet extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int flag = new commodity_add_post_JDBCAction().PostInfobyadd(commodity);
