...
public class commodity_category2_get_JDBCAction {
    public ArrayList<CategoryBean> GetInfobyCategory(){
        ...
        try {
            ...
            while (res.next()){
                ...
                category.setType2_id(res.getInt("id"));
                category.setType2_name(res.getString("typename"));
                category.setType_id(res.getInt("typeid"));
