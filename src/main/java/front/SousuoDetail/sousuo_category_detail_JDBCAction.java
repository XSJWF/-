...
public class sousuo_category_detail_JDBCAction {
    public ArrayList<CommodityBean> GetCommoditybycategory(String category,int keyword){
        ...
        try {
            ...
            String sql = "select * from tb_shangpin where type"+category+"id = "+keyword+"";
