...
public class sousuo_detail_JDBCActon {
    public ArrayList<CommodityBean> GetInfobyCommodity(String keyword){
        ...
        try {
            ...
            String sql = "select * from tb_shangpin where jianjie like '%"+keyword+"%'";
