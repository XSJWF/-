...
public class Mallhomepage_commodity_JDBCAction {
    public ArrayList<CommodityBean> GetInfobyCommodity(){
        ArrayList<CommodityBean> commoditylist = new ArrayList<>();
        ...
        try {
            ...
            String sql = "select top 6 * from tb_shangpin";
